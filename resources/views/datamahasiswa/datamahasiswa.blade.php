...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 text-gray-800">
            <i class="fas fa-users fa-fw text-info"></i> Data Mahasiswa
        </h1>
        <a href="{{ route('datamahasiswa.create') }}" class="btn btn-info btn-sm shadow-sm">
    ...
    <div class="card border-0 shadow-sm rounded-4">
                ...
                <table class="table table-bordered align-middle text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->email }}</td>
                            <td>
                                <a href="{{ route('datamahasiswa.edit', $item->id) }}" class="btn btn-sm btn-info me-1">
        ...
        @else
            <div class="text-center py-5">
                ...
                <a href="{{ route('datamahasiswa.create') }}" class="btn btn-info">
