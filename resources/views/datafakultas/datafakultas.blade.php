...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 text-gray-800 fw-bold">
            <i class="fas fa-university fa-fw text-info me-2"></i> Data Fakultas
        </h1>
        <a href="{{ route('datafakultas.create') }}" class="btn btn-info shadow-sm">
    ...
    <div class="card border-0 shadow-sm rounded-4">
        ...
        @else
            <div class="text-center py-5">
                ...
                <a href="{{ route('datafakultas.create') }}" class="btn btn-info">
